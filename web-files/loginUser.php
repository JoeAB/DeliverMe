...
?>
 ...
 $db = mysql_connect("studentdb-maria.gl.umbc.edu","bjoseph2","bjoseph2");
	...
	$login =  mysql_real_escape_string(htmlspecialchars($_POST["custName"]));
	$pass =  mysql_real_escape_string(htmlspecialchars($_POST["custPass"]));
	

	$select = "Select * From Customer where email ='$login' AND password = '$pass' " ;
